            ...
            return(
                <div className="post-form-wrapper">
                        <form className="post-form" onSubmit={this.handleSubmit}>
                            <textarea className="input-text-box" id="postText" placeholder="Text" type="text" onChange = {this.handleChange} value={this.state.postText || ""}></textarea>
                            <p className="p1">Forfatter</p>
                            <input className ="input-author" id="postAuthor" placeholder="Author" type="text" onChange = {this.handleChange} value={this.state.postAuthor || ""}></input>
                            <p className="p2">Overskrift</p>
                            <input className ="input-headline" id="postHeadline" placeholder="Headline" type="text" onChange = {this.handleChange} value={this.state.postHeadline || ""}></input>
                            <input className ="input-submit-btn" type="submit" value="Submit new post" />
                        </form> 
                </div>
            );
    }  
